...
--     name_disease VARCHAR(20) NOT NULL PRIMARY KEY,
--     survivalt_rate float
-- );
...
--     symptoms_family INT,
--     disease VARCHAR(20),
--     FOREIGN KEY (id_ethnicity) REFERENCES ethnicity(id_et),
--     FOREIGN KEY (id_gender) REFERENCES gender(id_gen),
--     FOREIGN KEY (symptoms_family) REFERENCES symptoms(family),
--     FOREIGN KEY (disease) REFERENCES disease(name_disease)
