type val1= string | number | boolean;

function doX(val: val1):val1 {
    return val == 8;
}
...
//excrice1 
type UnionString=String |String[];
type UnionBoolNum=boolean|number;
...
function concat(strArray: UnionString, isPrint: UnionBoolNum): void {
...
type phoneNumbers=number[]| string[] | string | number 

function print_numbers(phoneNumbersTemp:phoneNumbers):void{
